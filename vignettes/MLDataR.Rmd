...
The [ConfusionTableR](https://cran.r-project.org/web/packages/ConfusionTableR/index.html) package has a `dummy_encoder` function baked into the package. To code up the dummy variables you could use an approach similar to below:
